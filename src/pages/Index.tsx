...
const Index = () => {
  ...
  const [loading, setLoading] = useState(true);;    conversationsAssigned: 0,  const [stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,useStateconst const[stats, setStats] = useState<DashboardStats>({const: 0,
const  const [stats, setStats] = useState<DashboardStats>({ [stats, setStats] = useState<DashboardStats>({const useState[stats, setStats] = useState<DashboardStats>({
    totalContacts: 0,totalContacts: 0,
    totalMessages: 0,totalMessages: 0,
    activeCampaigns: 0,activeCampaigns: 0,
    scheduledCampaigns: 0,scheduledCampaigns: 0,
    sentMessages: 0,sentMessages: 0,
    conversationsAssigned: 0,conversationsAssigned: 0,
